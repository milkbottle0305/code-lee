    ...
    <div className="flex items-center justify-center space-x-2 py-4">
      ...
      {getPageNumbers().map((pageNumber, index) => {
        if (pageNumber === -1 || pageNumber === -2) {
          return (
            <Button key={`ellipsis-${index}`} variant="outline" size="sm" disabled className="text-muted-foreground">
              ...
            </Button>
          )
        }
        ...
        return (
          <Button
            ...
            size="sm"
            className={
              currentPage === pageNumber ? "font-medium bg-primary text-primary-foreground" : "text-muted-foreground"
            }
